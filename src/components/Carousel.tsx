        ...
        <>
          <div className="navigation-wrapper relative">
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center bg-black bg-opacity-75 p-12 rounded-lg">
                <h1 className="text-2xl font-bold">Welcome to VampirismMC</h1>
                <p className="mb-5">Server is not yet released. Join our Discord for news and updates.</p>
                <div className="flex justify-center space-x-4"> {/* Increased space between buttons */}
                    <a href="https://discord.gg/vffG5aBj78" target="_blank" rel="noopener noreferrer">
                        <button className="flex items-center space-x-4 px-4 py-2 bg-blue-500 text-white rounded-lg font-bold hover:bg-blue-700"> {/* Added flex and space-x-2 to align SVG and text */}
                    ...
                    <button className="px-4 py-2 bg-green-500 text-white rounded-lg font-bold hover:bg-green-700">
                        Learn More
                    </button>
                </div>
            </div>
